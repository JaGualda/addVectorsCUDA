...
{
   struct timeval start, stop, starts, stops;
   float timet;
   unsigned int n;
   ...
   gettimeofday(&stop,0);
   timet = (stops.tv_sec + stops.tv_usec * 1e-6)-(starts.tv_sec + starts.tv_usec * 1e-6);
   printf("Tiempo suma = %f s\n",timet);
